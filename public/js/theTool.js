...
theToolController
  .controller('SessionsController', function ($rootScope, $scope, $location, $window, $routeParams, $sce, SessionFactory){
      ...
      console.log($scope.sessions[$scope.sessions.length - 1]);
